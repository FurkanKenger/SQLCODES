...
SELECT urun_adi, min(urun_miktari)AS minumum_urun_miktarı, max(urun_miktari)AS maksimum_urun_miktari from
manav group by urun_adi order by maksimum_urun_miktari
...
-- personelin calıstıgı ülkeleri listeleyiniz
